...
export function ProfileScreen() {
  ...
  return <Shell>
    ...
    <View style={styles.profileHero}>
      ...
      <Text style={styles.memberName}>{member.name}</Text><Text style={styles.memberMeta}>{member.membership} · {member.id}</Text>
      <View style={styles.heroStats}><ProfileStat label="OBJETIVO" value={goalLabels[preferences.goal]} /><View style={styles.heroDivider} /><ProfileStat label="PROGRAMA" value={programme.title} /></View>
    </View>
    ...
    <Card style={styles.settingsCard}>
      ...
      <MenuRow icon="time-outline" label="Histórico de treino" value="Ver sessões" onPress={() => navigation.navigate('WorkoutHistory')} last />
    </Card>
    ...
    <Card style={styles.settingsCard}>
      ...
      <Info icon="barbell-outline" label="Treino semanal" value={`${preferences.trainingDays} dias`} />
